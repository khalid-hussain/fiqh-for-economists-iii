...
\begin{itemize}
\item {\arabicsans{تمليك}} (Transfer of Ownership). Based on the narration {\arabicfont{تَهَادُوا تَحَابُّوا}} (Exchange gifts so that you will love each other), reported by Imam al-Bukhārī in \textit{Adab al-Mufrad}.
\item {\arabicsans{إسقاط}} (Cancellation of a Debt). Based on the \textit{āyah},\\{\arabicsans{...فَإن طِبْنَ لَكُمْ عَنْ شَيْءٍ مِّنْهُ نَفْساً فَكُلُوهُ هَنِيئاً مَّرِيئاً}}\\
...
\begin{enumerate}
  ...
  \item \arabicsans{موهوب له} (Donee)
...
\begin{enumerate}
\item \arabicsans{المُورِّث} The Deceased
\item \arabicsans{الوارث} The Heirs
\item \arabicsans{الموروث أو التركة} The estate of the deceased
\end{enumerate}
\end{frame}

\begin{frame}{Pillars of Inheritance -- The Deceased \hfill \arabicsans{المُورِّث}}
\begin{itemize}
...
\begin{frame}{Pillars of Inheritance -- The Estate of the Deceased \hfill {الموروث أو التركة}}
\begin{itemize}

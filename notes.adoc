...
. _Taʿṣīb_ — without fixed portion
...
. Husband
.. The deceased has no _farʿ_.
.. Cannot be blocked.

==== 1/4

. Husband
.. The deceased has _farʿ_.
.. Cannot be blocked.
. Wife
.. The deceased has no _farʿ_.
.. Cannot be blocked.
...
[.lead]
Literal meaning: the tightening.
...
.. The groups are {S, D}, {SS, SD}, {FB, FS}, and {CB, CS}.
.. When a group exists, they share the inheritance [and the ratio of 1:2 doesn't apply.] (CLARIFY)
...
.. They are upgraded to the rank of their male counterpart.
.. .Groups are {FS with D or SD}

include::inheritance_calculations.adoc[]
